...
### 3. Test Communication with HMI

Wait for a short period to allow the nodes sufficient time to complete their automatic configuration. Once this process is complete, access the HMI container:
...
> DOI: <https://doi.org/10.1016/j.jisa.2025.104199>